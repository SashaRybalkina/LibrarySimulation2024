...
public class LibraryGenericTester {
	...
	public void testPhoneLibCheckout() {
		...
		//My tests
		assertTrue(phoneLib.checkout(9780446580342L, patron, 1, 1, 2008));
		assertFalse(phoneLib.checkout(794038578493L, patron, 1, 1, 2008));
		assertFalse(phoneLib.checkout(794038578493L, new PhoneNumber(""), 1, 1, 2008));
	}
	...
	public void testPhoneLibCheckin() {
		...
		//My tests
		PhoneNumber patron2 = new PhoneNumber("801.256.3582");
		phoneLib.checkout(9780330351690L, patron2, 1, 1, 2008);
		phoneLib.checkout(9780374292799L, patron2, 1, 1, 2008);
		phoneLib.checkout(9780446580342L, patron2, 1, 1, 2008);
		assertTrue(phoneLib.checkin(patron2));
	}
}
